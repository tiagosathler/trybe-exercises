...
from src.pokemons import (
    retrieve_pokemons_by_type_from_reader,
    retrieve_pokemons_by_type_from_filepath,
)
...
def test_retrieve_pokemons_by_type_from_reader(
    ...
    assert grass_type_pokemon in retrieve_pokemons_by_type_from_reader(
        "Grass", fake_file
    )


def test_retrieve_pokemons_by_type_from_filepath():
    ...
    with patch("builtins.open", mock_open(read_data=pokemon_json_content)):
        ...
        assert retrieve_pokemons_by_type_from_filepath("Grass", "dummy") == [
            grass_type_pokemon
        ]
